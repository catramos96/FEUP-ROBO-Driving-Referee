...
#lauch master
os.system("gnome-terminal -e 'bash -c \"source devel/setup.bash; roscore; exec bash\"'")
time.sleep(1)

#lauch simulator
os.system("gnome-terminal -e 'bash -c \"source devel/setup.bash; roslaunch conde_world spawn_world.launch; exec bash\"'")
time.sleep(1)
